...
export default function Navbar() {
  return (
    <nav className="nav-shell sticky top-0 z-50 backdrop-blur-xl border-b border-verse-border/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-14">
          ...
          <NavLink to="/" className="flex items-center gap-2.5 group">
            <div className="brand-mark relative">
              <div className="w-7 h-7 rounded-md bg-gradient-to-br from-verse-red to-verse-red-glow flex items-center justify-center shadow-[0_0_15px_rgba(232,32,63,0.3)] group-hover:shadow-[0_0_25px_rgba(232,32,63,0.5)] transition-shadow">
                <RadioTower size={16} className="text-white" />
              </div>
            </div>
          ...
          <div className="hidden lg:inline-flex hackathon-chip text-xs mono">
            <span className="hackathon-chip-dot" />
            <Sparkles size={13} className="text-verse-red" />
            Pocket FM x OpenAI Hackathon
          </div>
