...
export const mockIssues = [
  {
    ...
    rewrite_variants: [
      {
        id: "mock-variant-001-a",
        issue_id: "issue-001",
        variant_id: "v1",
        original_span: "He'd been cowardly during the interviews — avoiding direct confrontation with the dock workers, letting witnesses walk away without pressing them.",
        tone_label: "Subtle Suspicion",
        rewritten_text: "He'd been unusually guarded during the interviews — avoiding direct confrontation with the dock workers, letting witnesses walk away before Maya could press them further.",
        rationale: "Keeps Rio's changed behavior suspicious without directly contradicting his established bravery.",
      },
      {
        id: "mock-variant-001-b",
        issue_id: "issue-001",
        variant_id: "v2",
        original_span: "He'd been cowardly during the interviews — avoiding direct confrontation with the dock workers, letting witnesses walk away without pressing them.",
        tone_label: "Match Original",
        rewritten_text: "He'd been restrained during the interviews — avoiding direct confrontation with the dock workers, letting witnesses walk away with a look that told Maya he was holding something back.",
        rationale: "Preserves the noir tension while implying intentional restraint instead of cowardice.",
      },
      {
        id: "mock-variant-001-c",
        issue_id: "issue-001",
        variant_id: "v3",
        original_span: "He'd been cowardly during the interviews — avoiding direct confrontation with the dock workers, letting witnesses walk away without pressing them.",
        tone_label: "Concise",
        rewritten_text: "He'd been cautious during the interviews, letting the dock workers talk without pushing them the way Maya knew he usually would.",
        rationale: "Shortens the contradiction into behavior that can be explained by the later reveal.",
      },
    ],
    patch_decision: null,
    resolved: false,
  ...
  },
  {
    ...
    rewrite_variants: [
      {
        id: "mock-variant-002-a",
        issue_id: "issue-002",
        variant_id: "v1",
        original_span: "That night, Maya found a body washed up on the shore — despite the town's oldest law that the sea never returns the dead.",
        tone_label: "Ominous",
        rewritten_text: "That night, Maya found a body placed just above the tide line — close enough for the sea to be blamed, but too cleanly arranged to have been returned by it.",
        rationale: "Avoids breaking the sea rule while keeping the corpse discovery ominous.",
      },
      {
        id: "mock-variant-002-b",
        issue_id: "issue-002",
        variant_id: "v2",
        original_span: "That night, Maya found a body washed up on the shore — despite the town's oldest law that the sea never returns the dead.",
        tone_label: "Dramatic",
        rewritten_text: "That night, Maya found a body on the shore, the sand around it dry and undisturbed — proof that someone wanted the town to think the sea had broken its oldest law.",
        rationale: "Turns the contradiction into a deliberate mystery beat.",
      },
      {
        id: "mock-variant-002-c",
        issue_id: "issue-002",
        variant_id: "v3",
        original_span: "That night, Maya found a body washed up on the shore — despite the town's oldest law that the sea never returns the dead.",
        tone_label: "Concise",
        rewritten_text: "That night, Maya found a body on the shore, but the sea had not delivered it.",
        rationale: "Keeps the reveal sharp while preserving the established world rule.",
      },
    ],
    patch_decision: null,
    resolved: false,
  ...
  },
  {
    ...
    rewrite_variants: [
      {
        id: "mock-variant-003-a",
        issue_id: "issue-003",
        variant_id: "v1",
        original_span: "'He's not dead, Maya — he's in hiding. I was cowardly, yes — but only because I was trying to keep you safe.'",
        tone_label: "Forward Hook",
        rewritten_text: "'He's not dead, Maya — he's in hiding. I know where the first marker is, and if you still trust me by sunrise, I'll take you to it.'",
        rationale: "Turns the reveal into forward motion toward finding her father.",
      },
      {
        id: "mock-variant-003-b",
        issue_id: "issue-003",
        variant_id: "v2",
        original_span: "'He's not dead, Maya — he's in hiding. I was cowardly, yes — but only because I was trying to keep you safe.'",
        tone_label: "Emotional",
        rewritten_text: "'He's not dead, Maya — he's in hiding. I can prove it. Your father left me one message, and I buried it because I thought it would keep you alive.'",
        rationale: "Keeps the emotional betrayal while adding a concrete next clue.",
      },
      {
        id: "mock-variant-003-c",
        issue_id: "issue-003",
        variant_id: "v3",
        original_span: "'He's not dead, Maya — he's in hiding. I was cowardly, yes — but only because I was trying to keep you safe.'",
        tone_label: "Match Original",
        rewritten_text: "'He's not dead, Maya — he's in hiding. I was trying to keep you safe, but if you want him back, the journal's last page is where we start.'",
        rationale: "Preserves Rio's confession and gives Maya an immediate path forward.",
      },
    ],
    patch_decision: null,
    resolved: false,
